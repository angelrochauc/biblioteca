...
<div id="layoutSidenav_content">
    ...
    <?php } ?>
    <main>
        <!-- Ver registro de los prestamos y su estado-->
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <table class="table" id="table">
                        ...
                        <!-- Opcion para indicar que se recibio el libro de vuelta-->
                        <tbody>
        ...
        <!-- modal para llenar formulario d eprestamo-->
            ...
            <div class="modal-dialog  modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!--Para listar los libros disponibles -->
                            ...
                            <div class="form-group">
                                ...
                                <select id="buscar_libro" class="form-control" name="libro">
                                    <?php foreach ($data['libros'] as $libro) { ?>
                                        <option value="<?php echo $libro['id']; ?>"><?php echo $libro['titulo'] ." - " . $libro['descripcion']?></option>
